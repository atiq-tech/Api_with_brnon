...
class CategoryDetailsProduct extends StatefulWidget {
  ...
  @override
  State<CategoryDetailsProduct> createState() => _CategoryDetailsProductState();
}

class _CategoryDetailsProductState extends State<CategoryDetailsProduct> {
                              ...
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: AssetImage(widget.catProImage),
                                        fit: BoxFit.fill),
