  ...
  Future<List<ProductModel>> GetApiData() async {
    try {
      ...
      if (Response.statusCode == 200) {
        ...
        } //inifit data koi paitese  app e, kon data fetch korar shomoy, jokon ami new allproductlistDATA DILAN RELOAD TOKHN THEKE,
        //app er ekta ss tule whatsapp a dao ok dicchi,,, peie cho?
      }
      setState(() {
        isLoading = false;
      });
                          ...
                          setState(() {
                            Navigator.of(context)
                              ...
                              return ShortDetailsPage(
                                ...
                                pShortDetails: allgridProduct[index]
                                    ["pShortDetails"],
                                pCategoryId: allgridProduct[index]
                                    ["pCategoryId"],
                              );
                            })).then((_) => setState(() {}));
                          });
